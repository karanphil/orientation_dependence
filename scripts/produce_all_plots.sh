...
# python ${source}/orientation_dependence/scripts/plot_f_v_values.py --in_values_sf MT_profiles_max_mean_corrected_comparison_v_values.txt ihMT_profiles_max_mean_corrected_comparison_v_values.txt --in_values_sf MT_profiles_maximum_corrected_comparison_v_values.txt ihMT_profiles_maximum_corrected_comparison_v_values.txt --in_values_sf MT_profiles_mean_corrected_comparison_v_values.txt ihMT_profiles_mean_corrected_comparison_v_values.txt  --out_filename v_values_plot.png -f --value_type v --figsize 5 4;