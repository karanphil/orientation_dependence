...
for method in 'correction_max_mean' 'correction_mean' 'correction_maximum';
    ...
    python ${source}/orientation_dependence/scripts/scil_orientation_dependence_plot.py --measures $measures --in_bundles ../characterization_mean/means/*/1f_results.npz --in_bundles means/*/1f_results.npz --bundles_order $bundles --in_polyfits ../characterization_mean/means/*/1f_polyfits.npz --in_polyfits means/*/1f_polyfits.npz --out_filename ${name}_means_comparison${name_bundle_choice}.png --plot_std --common_yticks --write_mean_std --horizontal_test --figsize $figsize -f --check_nb_voxels_std --min_nb_voxels 10;
    # multi-fiber
    ...
    python ${source}/orientation_dependence/scripts/scil_orientation_dependence_plot.py --measures $measures --in_bundles ../characterization_mean/means/*/1f_results.npz --in_bundles means/*/1f_results.npz --bundles_order $bundles --out_filename ${name}_means_comparison${name_bundle_choice}.png --plot_std --write_mean_std --horizontal_test --figsize $figsize -f -v $set_yticks --check_nb_voxels_std --min_nb_voxels 10 --save_stats;
    # ihMT
