...
for bundle in bundles/sub-026-hc_ses-3/bundles/*;
    ...
    # if [ $bundle_name != "CR_L" ] && [ $bundle_name != "CR_R" ];
        ...
        roi_argument="test_tracto_to_bundle/fixel_analysis/voxel_density_mask_${bundle_name}.nii.gz";
        ...
        pathdir="test_tracto_to_bundle/characterization/${bin_width_dir}/${bundle_name}";
        mkdir -p $pathdir;
